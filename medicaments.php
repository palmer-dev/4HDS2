...
$listMedicaments = selectMedicaments()["content"];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>SB Admin 2 - Médicaments</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row justify-content-between align-items-center">
                            ...
                            <a href="createMedicament.php" class="btn btn-success btn-circle btn-sm">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($listMedicaments as $medicament) : ?>
                                            <tr>
                                                <td><?= $medicament["nom"] ?></td>
                                                <td><?= $medicament["description"] ?></td>
                                                <td><?= $medicament["reference"] ?></td>
                                                <td><?= $medicament["stock"] ?></td>
                                                <td><?= $medicament["prix"] ?>€</td>
                                                <td><?= $medicament["token"] ?></td>
                                                <td>
                                                    <a href="./updateMedicament.php?id=<?= $medicament["id"] ?>" class="btn btn-info btn-circle btn-md">
                                                        <i class="fas fa-pen"></i>
                                                    </a>
                                                    <a href="./deleteElement.php?element=medicament&id=<?= $medicament["id"] ?>" class="btn btn-danger btn-circle btn-md">
