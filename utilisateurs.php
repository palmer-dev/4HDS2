...
<head>
    ...
    <title>SB Admin 2 - Utilisateurs</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row justify-content-between align-items-center">
                            ...
                            <a href="createUser.php" class="btn btn-success btn-circle btn-sm">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($listUsers as $utilisateur) : ?>
                                            <tr>
                                                <td><?= $utilisateur["nom"] ?></td>
                                                <td><?= $utilisateur["prenom"] ?></td>
                                                <td><?= $utilisateur["role"] ?></td>
                                                <td><?= $utilisateur["token"] ?></td>
                                                <td><?= $utilisateur["created_at"] ?></td>
                                                <td><?= $utilisateur["updated_at"] ?></td>
                                                <td>
                                                    <a href="./updateUser.php?id=<?= $medicament["id"] ?>" class="btn btn-info btn-circle btn-md">
                                                        <i class="fas fa-pen"></i>
                                                    </a>
                                                    <a href="./deleteElement.php?element=user&id=<?= $utilisateur["id"] ?>" class="btn btn-danger btn-circle btn-md">
